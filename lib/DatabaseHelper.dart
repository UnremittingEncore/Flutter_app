...
class DatabaseHelper{
  ...
  static final databaseName = "UserInformation.db";
  ...
  onCreateDatabaseTable(Database database, int version) async{
    ...
    String createTablequery = "CREATE TABLE $databaseTable($columnId INTEGER PRIMARY KEY,$columnname TEXT NOT NULL,$columnAge INTEGER NOT NULL)";
